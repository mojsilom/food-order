    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            if (!_roleManager.RoleExistsAsync(SD.KitchenRole).GetAwaiter().GetResult())
            {
                ...
                {
                    UserName = "admin@razorpagesproject.com",
                    Email = "admin@razorpagesproject.com",
                    EmailConfirmed = true,
                    FirstName = "Marko",
                    LastName = "Markovic"
                }, "Admin-123").GetAwaiter().GetResult();

                ApplicationUser user = _db.ApplicationUser.FirstOrDefault(u => u.Email == "admin@razorpagesproject.com");
